...
export async function getUV(input) {
  ...
  // Allow user-selected WISP server (stored in localStorage) with a sensible default.
  let wispUrl = (typeof localStorage !== 'undefined' && localStorage.getItem('wispUrl')) || "wss://anura.pro/";
